...
//用cookie记住密码、用户名(页面1)
    ...
    if(cook!=null){
        for(int i=0;i<cook.length;i++){
        	if(cook[i].getName().endsWith("activeCode2")){
    ...
    info[0]=new String(info[0].getBytes("ISO8859_1"),"UTF-8");
    info[1]=new String(info[1].getBytes("ISO8859_1"),"UTF-8");
    %>
	<div id="divcontent">
								...
								<table width="85%" border="0" cellspacing="0">
									<tr>
										...
										<td style="text-align:left; padding-top:30px; width:60%"><h1>您还没有注册？</h1>
											<p>注册新用户，享受更优惠价格!</p>
											<p>千种健身器材，供你挑选！注册即享受丰富折扣和优惠，便宜有好货！超过万件健身器材任您选。</p>
