								...
								<table width="100%" border="0" cellspacing="0">
									...
									<tr>
										<td>
											...
											<c:if test="${(order.receivestate==0)&&(order.sendstate==1) }">
											<p style="text-align:right">
												<a href="${pageContext.request.contextPath}/Receive?orderid=${order.id}" onclick="javascript:return o_del()">
													<img src="${pageContext.request.contextPath }/client/images/bbb.jpg" width="204" height="66" border="0" /> 
												</a>
											</p>
											</c:if>
											<c:if test="${(order.receivestate==1)&&(order.evaluatestate==0)}">
											<p style="text-align:right">
												<a href="${pageContext.request.contextPath}/findOrderById?orderid=${order.id} ">
													<img src="${pageContext.request.contextPath }/client/images/aaa.png" width="204" height="65" border="0" /> 
												</a>
											</p>
											</c:if>
										</td>
