...
<script type="text/javascript">
	function changeImage() {
		// 改变验证码图片中的文字，看不清换一张的功能（重新发送请求给CheckImageServlet）
		document.getElementById("img").src = "${pageContext.request.contextPath}/imageCode?time="
				+ new Date().getTime();   //以时间作为不断变化的参数，生成随机的验证码
	}
</script>
</head>
					...
					<td style="padding: 30px"><h1>新用户注册</h1>
						<table width="70%" border="0" cellspacing="2" class="upline">
							...
							<tr>
								...
								<td colspan="2"><span id="usernameMsg"></span><font color="#999999">字母数字下划线1到10位,不能数字开头</font></td>
							</tr>
							<tr>
							...
							<tr>
                                ...
                                <select name="occupation" id="occupation">
										...
										<option value="职业运动员">职业运动员</option>
										<option value="健身房商户">健身房商户</option>
										<option value="已退休">已退休</option>
										<option value="上班族">上班族</option>
										<option value="其余健身爱好者">其余健身爱好者</option>
								</select>
								</td>
								<td>&nbsp;</td>
							</tr>
						...
						<table width="80%" border="0" cellspacing="2" class="upline">
							...
							<tr>
								...
								<img src="${pageContext.request.contextPath}/imageCode" width="180"  <%-- 引用验证码工具类  --%>
