...
<body class="main">
	...
	<div id="divpagecontent" width=1000px>
							...
							<td style="padding:20px"><p><b>我的订单</b></p>
								...
								<table width="100%" border="0" cellspacing="0" class="tableopen">
									<tr>
										...
										<td bgcolor="#A3B6E6" class="tableopentd01">支付状态</td>
										<td bgcolor="#A3B6E6" class="tableopentd01">发货状态</td>
										<td bgcolor="#A3B6E6" class="tableopentd01">收货状态</td>
										<td bgcolor="#A3B6E6" class="tableopentd01">评价状态</td>
									...
									<c:forEach items="${orders}" var="order">
										<tr>
											...
											<td class="tableopentd02">${order.sendstate==0?"未发货":"已发货"}</td>
											<td class="tableopentd02">${order.receivestate==0?"未收货":"已收货"}</td>
											<td class="tableopentd02">${order.evaluatestate==0?"未评价":"已评价"}</td>
