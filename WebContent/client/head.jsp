<%@page import="cn.itcast.itcaststore.exception.ActiveUserException"%>
<%@page import="cn.itcast.itcaststore.service.UserService"%>
				    	...
				    	for(int i=0;i<cooks.length;i++){
				        	if(cooks[i].getName().endsWith("activeCode")){
				        		try {
				        			...
				        			user1 = userService.findUserByActiveCode(activeCode);
