...
<HEAD>
	...
	<LINK href="${pageContext.request.contextPath}/salesman/css/Style.css" type="text/css" rel="stylesheet">
	<script language="javascript" src="${pageContext.request.contextPath}/salesman/js/public.js"></script>
	<script language="javascript" src="${pageContext.request.contextPath}/salesman/js/check.js"></script>
		...
		<table cellSpacing="1" cellPadding="5" width="100%" align="center"
			...
			<TR>
				<td align="center" colSpan="4" class="sep1">
					<img src="${pageContext.request.contextPath}/salesman/images/shim.gif">
				</td>
			</TR>
			<tr>
