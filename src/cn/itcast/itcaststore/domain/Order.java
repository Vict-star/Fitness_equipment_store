...
public class Order {
	...
	private int sendstate; // 发货状态
	private int receivestate;// 收货状态
	private int evaluatestate;//评价状态
	...
	public String toString() {
		return "Order [id=" + id + ", money=" + money + ", receiverAddress="
				...
				+ ", sendstate=" + sendstate + ", receivestate=" + receivestate + ", evaluatestate=" + evaluatestate
